#ifndef COLLAPSED_HMM_H
#define COLLAPSED_HMM_H
...
/** Respresents the genotyping HMM. Improved version. **/
...
public:
	...
	**/
	CollapsedHMM(std::vector<UniqueKmers*>* unique_kmers, bool run_genotyping, bool run_phasing, double recombrate = 1.26, bool uniform = false, long double effective_N = 25000.0L);
