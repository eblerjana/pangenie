...
TransitionProbabilityComputer::TransitionProbabilityComputer(size_t from_variant, size_t to_variant, double recomb_rate, size_t nr_paths)
{
...
//	long double recomb_prob = (1.0L - exp(-(2.0L*distance)/100)) / 2.0L;
	//  TODO: correct? using Li-Stephens recombination probability
	long double recomb_prob = 1.0L - exp(-distance/ (long double) nr_paths);
