...
void CollapsedHMM::index_columns() {
	// TODO need to construct an index for each column, needs to keep track of which paths cover which allele
	// TODO: maybe add this into a new TransitionProbability class 
