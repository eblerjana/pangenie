...
int main(int argc, char* argv[]) {
	...
	argument_parser.add_command("PanGenie-genotype [options] -f <unique-kmers> -i <reads.fa/fq>\nPanGenie-genotype [options] -i <reads.fa/fq> -r <reference.fa> -v <variants.vcf>");
