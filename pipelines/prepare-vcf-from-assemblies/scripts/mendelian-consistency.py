...
def run_mendelian(vcf, ped, samples, output, hap_chroms, remove_children=False):
	# map name -> [trio]
...
if __name__ == '__main__':
	...
	parser_mendelian.add_argument('-hap', metavar='HAPLOIDS', default="", help='Comma-separated list of haploid chromosomes.')
	...
	if args.subparser_name == 'filter':
		hap_chroms = [h for h in args.hap.strip().split(',')]
		run_mendelian(args.vcf, args.ped, args.samples, args.o, hap_chroms, args.remove_children)
