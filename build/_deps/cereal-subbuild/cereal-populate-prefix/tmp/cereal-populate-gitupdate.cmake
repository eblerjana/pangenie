...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/cluster/apps/sfos/bin/git" rev-parse "${ref}^{commit}"
...
execute_process(
  COMMAND "/cluster/apps/sfos/bin/git" show-ref "v1.3.1"
  WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/cluster/apps/sfos/bin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/cluster/apps/sfos/bin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/cluster/apps/sfos/bin/git" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
...
execute_process(
  COMMAND "/cluster/apps/sfos/bin/git" status --porcelain
  WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/cluster/apps/sfos/bin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/cluster/apps/sfos/bin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/cluster/apps/sfos/bin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/cluster/apps/sfos/bin/git" rebase --abort
      WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/cluster/apps/sfos/bin/git" stash pop --index --quiet
          WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src'."
    ...
    execute_process(
      COMMAND "/cluster/apps/sfos/bin/git" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/cluster/apps/sfos/bin/git" reset --hard --quiet
      WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
    )
    execute_process(
      COMMAND "/cluster/apps/sfos/bin/git" stash pop --quiet
      WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/cluster/apps/sfos/bin/git" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src"
      )
      execute_process(
        COMMAND "/cluster/apps/sfos/bin/git" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/cluster/work/pausch/alex/software/Alex-pangenie/build/_deps/cereal-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
